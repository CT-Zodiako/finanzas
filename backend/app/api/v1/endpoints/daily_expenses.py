...
@router.post("")
def create_daily_expense(expense: DailyExpenseCreate, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
...
@router.get("")
def get_all_daily_expenses(db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
    service = DailyExpenseService(db)
...
def get_daily_expense(expense_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
    service = DailyExpenseService(db)
...
def update_daily_expense(expense_id: int, expense: DailyExpenseUpdate, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
    service = DailyExpenseService(db)
...
def delete_daily_expense(expense_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
    service = DailyExpenseService(db)
